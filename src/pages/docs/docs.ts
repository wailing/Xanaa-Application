...
export class DocsPage {
  ...
  var dd = {
     content: [
        ...
        { text: ' ', style: 'droite', margin: [ 5, 2, 40, 20 ] },
       { text: 'Je soussigné, '+this.myUser.name+' '+this.myUser.firstname+' , '+this.myUser.profession+', demeurant au '+this.myUser.adress+', '+this.myUser.postCode+', '+this.myUser.city+', reconnaît avoir opté pour le système de la mensualisation pour le paiement de mon impôt sur le revenu.', style: 'gauche',  margin: [ 5, 60, 10, 20 ]  },
       ...
       { text: ' ', style: 'droite', margin: [ 5, 2, 40, 20 ] },
       { text: ' ', style: 'droite', margin: [ 5, 2, 40, 20 ] },
       { text: ' '+this.myUser.name+' '+this.myUser.firstname, style: 'droite', margin: [ 5, 2, 40, 20 ] }
     ],
     ...
     gauche: {
        ...
        console.log(dd);
      pdfmake.createPdf(dd).download('Lettre resiliation.pdf');
}
}
